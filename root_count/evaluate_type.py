...
if __name__ == '__main__':
    ...
    # Training Set
    test_images, test_labels, image_names = dataset_utils.image_class_label_processor_2(para.test, para.img_rows, para.img_cols)
    test_images = test_images.astype(np.float32)
    test_images = test_images / 255.0
    test_labels = np_utils.to_categorical(test_labels, para.type_classes)
    ...
    for p_label, t_labels, img_names in zip(pred_labels, test_labels, image_names):
        ...
        print(img_names, t_labels, p_label)
